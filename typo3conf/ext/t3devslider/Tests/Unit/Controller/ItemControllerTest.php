<?php
namespace T3Dev\T3devslider\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class T3Dev\T3devslider\Controller\ItemController.
 *
...
class ItemControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \T3Dev\T3devslider\Controller\ItemController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('T3Dev\\T3devslider\\Controller\\ItemController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllItemsFromRepositoryAndAssignsThemToView()
	{
		...
		$itemRepository = $this->getMock('T3Dev\\T3devslider\\Domain\\Repository\\ItemRepository', array('findAll'), array(), '', FALSE);
