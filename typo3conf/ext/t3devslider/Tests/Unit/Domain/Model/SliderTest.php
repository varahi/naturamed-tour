...
/**
 * Test case for class \T3Dev\T3devslider\Domain\Model\Slider.
 *
...
{
	/**
	 * @var \T3Dev\T3devslider\Domain\Model\Slider
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \T3Dev\T3devslider\Domain\Model\Slider();
	}
	...
	{
		$item = new \T3Dev\T3devslider\Domain\Model\Item();
